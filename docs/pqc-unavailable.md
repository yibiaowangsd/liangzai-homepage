...
| kem-17 · Hybrid Equivalent Punctured and Quasi-Cyclic | 0/4 | hep-qc-1、hep-qc-3、hep-qc-5、hep-qc-7 | WASM 运行失败 4 |
...
| sign-21 · ReSolveD-ɑ | 0/8 | ReSolveD-alpha-160f、ReSolveD-alpha-160s、ReSolveD-alpha-256f、ReSolveD-alpha-256s、ReSolveD-alpha-384f、ReSolveD-alpha-384s、ReSolveD-alpha-512f、ReSolveD-alpha-512s | 原生测试失败 6；原生测试超时 2 |
...
| 编号与候选 | 可运行参数 | 尚不可运行的参数 | 原因（组数） |
| --- | ---: | --- | --- |
| hash-11 · Garnet | 7/8 | Garnet_1024_DM4x4 | 原生测试失败 1 |
